...
$_lang["modx_footer1"] = '&copy; 2004 - 2026 <a href="https://evo.im/" target="_blank" style="color: green; text-decoration:underline">Evolution CMS</a> Content Management Framework (CMF) проект. Всички права запазени. Evolution CMS е лицензиран под GNU GPL.';
...
$_lang["php_security_notice"] = '<legend>Бележки за сигурността</legend><p>Тъй като MODx ще работи на вашата PHP версия, използването на MODx на тази версия не се препоръчва. Вашата версия на PHP е уязвима по отношение на дупки в сигурността. Моля,обновете към PHP версия [+min_version+] или по-висока. Препоръчително е да обновите версията си за сигурността на вашия сайт.</p>';
