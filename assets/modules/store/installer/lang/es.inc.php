...
$_lang["modx_footer1"] = '&copy; 2004 - 2026 del proyecto de <a href="https://evo.im/" target="_blank" style="color: green; text-decoration:underline">Evolution CMS</a>. Todos los derechos reservados. Evolution CMS tiene licencia GPL de GNU.';
...
$_lang["php_security_notice"] = '<legend>Aviso de Seguridad</legend><p>Aunque MODx puede funcionar con esta versión de PHP, no lo recomendamos. Tu versión de PHP es vulnerable a numerosos problemas de seguridad.  Por favor actualiza  a la versión PHP [+min_version+] o mayor, la cual resuelve estos problemas.  Se recomienda que actualices a esta versión para la seguridad de tu propio sitio de internet.</p>';
