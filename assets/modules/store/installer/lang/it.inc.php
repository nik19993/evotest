...
$_lang["php_security_notice"] = '<legend>Avviso di Sicurezza</legend><p>Anche se MODx funziona con la vostra versione di PHP, vi suggeriamo di non farlo. La vostra versione di PHP ha numerosi problemi di sicurezza. Un aggiornamento a PHP versione [+min_version+] o successiva corregger&agrave; questi problemi. Vi raccomandiamo di farlo per garantire la sicurezza del vostro sito web.</p>';
