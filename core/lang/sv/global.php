...
$_lang["files_download_zip"] = 'Ladda ner ZIP';
$_lang["files_delete_zip"] = 'Ta bort ZIP';
...
$_lang["image_base_upload_dir_message"] = 'Ange rotkatalogen för filöverföring för denna webbanvändare i filläsaren. Du kan använda en absolut sökväg, platshållaren [(base_path)] eller en sökväg relativ till den globala överföringskatalogen. Lämna tom för att använda systemets standard.';
$_lang["image_base_upload_dir_title"] = 'Filläsare uppladdningsrotkatalog';
...
$_lang["evo_release_title"] = 'Evolution CMS-versioner';
...
$_lang["page_data_scheduled_publishdate"] = 'Schemalagt publiceringsdatum';
$_lang["page_data_scheduled_publishdate_help"] = 'Om du anger ett schemalagt publiceringsdatum publiceras resursen när datumet nås. Lämna tomt för att inte schemalägga automatisk publicering.';
$_lang["page_data_actual_publishdate"] = 'Faktiskt publiceringsdatum';
$_lang["page_data_actual_publishdate_help"] = 'Skrivskyddad tidsstämpel från publishedon. Den visar när resursen faktiskt publicerades.';
...
$_lang["rss_url_releases_message"] = 'Ange URL:en för RSS-flödet för EVO-versioner.';
$_lang["rss_url_releases_title"] = 'RSS-flöde för EVO-versioner';
$_lang["rss_url_extras_default"] = 'https://evo.im/rss/extras.xml';
$_lang["rss_url_extras_message"] = 'Ange URL:en för RSS-flödet för EVO-tillägg.';
$_lang["rss_url_extras_title"] = 'RSS-flöde för Extras-versioner';
...
$_lang["extras_release_tab"] = 'Evolution CMS Extras-versioner';
$_lang["extras_release_title"] = 'Evolution CMS Extras-versioner';
...
$_lang["site_timezone_title"] = 'Webbplatsens tidszon';
$_lang["site_timezone_message"] = 'Välj en IANA-tidszon. Den används av PHP och programmet och hanterar sommartid automatiskt.';
$_lang["serveroffset_deprecated_message"] = '<b>Föråldrad:</b> denna fasta förskjutning finns kvar för kompatibilitet och tar inte hänsyn till sommartid. Använd helst webbplatsens tidszon.';
...
$_lang["tmplvars_binding_msg"] = 'Skriv @ för att välja databindning';
...
$_lang['eventlog_mail_sent'] = 'E-post skickad';
...
$_lang['mail_test_subject'] = 'Testmeddelande till :destination från :site';
$_lang['mail_test_automated_note'] = 'Detta är ett automatiskt testmeddelande. Inget svar krävs.';
