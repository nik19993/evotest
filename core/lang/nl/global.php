...
$_lang["files_download_zip"] = 'ZIP downloaden';
$_lang["files_delete_zip"] = 'ZIP verwijderen';
...
$_lang["image_base_upload_dir_message"] = 'Stel de rootmap voor het uploaden van bestanden in voor deze webgebruiker in de bestandsbrowser. Je kunt een absoluut pad, de placeholder [(base_path)] of een pad relatief tot de globale uploadmap gebruiken. Laat leeg om de systeemstandaard te gebruiken.';
$_lang["image_base_upload_dir_title"] = 'Rootmap voor bestandsbrowser uploaden';
...
$_lang["page_data_scheduled_publishdate"] = 'Geplande publicatiedatum';
$_lang["page_data_scheduled_publishdate_help"] = 'Als u een geplande publicatiedatum instelt, wordt de resource gepubliceerd wanneer die datum is bereikt. Laat leeg om geen automatische publicatie te plannen.';
$_lang["page_data_actual_publishdate"] = 'Werkelijke publicatiedatum';
$_lang["page_data_actual_publishdate_help"] = 'Alleen-lezen tijdstempel uit publishedon. Dit toont wanneer de resource daadwerkelijk is gepubliceerd.';
...
$_lang["rss_url_releases_message"] = 'Voer de URL in voor de RSS-feed van EVO-releases.';
$_lang["rss_url_releases_title"] = 'RSS-feed voor EVO-releases';
$_lang["rss_url_extras_default"] = 'https://evo.im/rss/extras.xml';
$_lang["rss_url_extras_message"] = 'Voer de URL in voor de RSS-feed van EVO-extra\'s.';
$_lang["rss_url_extras_title"] = 'RSS-feed voor Extras-releases';
...
$_lang["site_timezone_title"] = 'Tijdzone van de site';
$_lang["site_timezone_message"] = 'Selecteer een IANA-tijdzone. Deze wordt toegepast op PHP en de toepassing en houdt automatisch rekening met zomertijd.';
$_lang["serveroffset_deprecated_message"] = '<b>Verouderd:</b> deze vaste afwijking blijft behouden voor compatibiliteit en houdt geen rekening met zomertijd. Gebruik bij voorkeur de tijdzone van de site.';
...
$_lang["tmplvars_binding_msg"] = 'Typ @ om databinding te selecteren';
...
$_lang["hide_from_tree_title"] = 'Toon onderliggende pagina\'s';
$_lang["hide_from_tree_help"] = 'Vink aan om de onderliggende bronnen in de documentenstructuur weer te geven';
...
$_lang['eventlog_system_user'] = 'Systeem';
...
$_lang['mail_test_subject'] = 'Testbericht aan :destination van :site';
$_lang['mail_test_automated_note'] = 'Dit is een automatisch testbericht. Een antwoord is niet nodig.';
