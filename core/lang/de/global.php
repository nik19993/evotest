...
$_lang["jit"] = 'JIT';
$_lang["opcache_memory_details"] = '(%s verwendet / %s verfügbar), %s Treffer / %s Fehlschläge';
$_lang["opcache_reset_unavailable"] = 'Zurücksetzen nicht verfügbar';
$_lang["opcache_reset_complete"] = 'Zurücksetzen abgeschlossen';
$_lang["opcache_reset_failed"] = 'Zurücksetzen fehlgeschlagen';
$_lang["database_name"] = 'Datenbank-Name';
$_lang["database_overhead"] = '<b>Hinweis:</b> Overhead ist ungenutzter Speicherplatz, der von MySQL reserviert wurde. Um ihn freizugeben, klicken Sie auf den Overhead-Wert der entsprechenden Tabelle.';
...
$_lang["files_download_zip"] = 'ZIP herunterladen';
$_lang["files_delete_zip"] = 'ZIP löschen';
...
$_lang["image_base_upload_dir_message"] = 'Legen Sie das Wurzelverzeichnis für den Datei-Upload dieses Web-Benutzers im Datei-Browser fest. Sie können einen absoluten Pfad, den [(base_path)] Platzhalter oder einen Pfad relativ zum globalen Upload-Verzeichnis verwenden. Lassen Sie das Feld leer, um den Systemstandard zu verwenden.';
$_lang["image_base_upload_dir_title"] = 'Wurzelverzeichnis des Datei-Browsers hochladen';
...
$_lang["page_data_scheduled_publishdate"] = 'Geplantes Veröffentlichungsdatum';
$_lang["page_data_scheduled_publishdate_help"] = 'Wenn ein geplantes Veröffentlichungsdatum gesetzt ist, wird die Ressource zu diesem Zeitpunkt veröffentlicht. Leer lassen, um keine automatische Veröffentlichung zu planen.';
$_lang["page_data_actual_publishdate"] = 'Tatsächliches Veröffentlichungsdatum';
$_lang["page_data_actual_publishdate_help"] = 'Schreibgeschützter Zeitstempel aus publishedon. Er zeigt, wann die Ressource tatsächlich veröffentlicht wurde.';
...
$_lang["rss_url_releases_message"] = 'URL des RSS-Feeds für EVO-Releases eintragen.';
$_lang["rss_url_releases_title"] = 'RSS-Feed für EVO-Releases';
$_lang["rss_url_extras_default"] = 'https://evo.im/rss/extras.xml';
$_lang["rss_url_extras_message"] = 'URL des RSS-Feeds für EVO-Extras eintragen.';
$_lang["rss_url_extras_title"] = 'RSS-Feed für Extras-Releases';
...
$_lang["site_timezone_title"] = 'Zeitzone der Website';
$_lang["site_timezone_message"] = 'Wählen Sie eine IANA-Zeitzone. Sie wird auf PHP und die Anwendung angewendet und berücksichtigt automatisch die Sommerzeit.';
$_lang["serveroffset_deprecated_message"] = '<b>Veraltet:</b> Dieser statische Versatz bleibt aus Kompatibilitätsgründen erhalten und berücksichtigt keine Sommerzeit. Verwenden Sie bevorzugt die Zeitzone der Website.';
...
$_lang["tmplvars_binding_msg"] = 'Geben Sie @ ein, um eine Datenbindung auszuwählen';
...
$_lang["html_comment_message"] = 'Kommagetrennte Liste von Elementtypen, die im Seitenquelltext mit HTML-Kommentaren umschlossen werden: <b>snippets</b>, <b>chunks</b>, <b>tvs</b>, <b>snippetParams</b>';
...
$_lang['eventlog_mail_sent'] = 'E-Mail gesendet';
...
$_lang['mail_test_subject'] = 'Testnachricht an :destination von :site';
$_lang['mail_test_automated_note'] = 'Dies ist eine automatische Testnachricht. Eine Antwort ist nicht erforderlich.';
