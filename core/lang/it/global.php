...
$_lang["files_download_zip"] = 'Scarica ZIP';
$_lang["files_delete_zip"] = 'Elimina ZIP';
...
$_lang["image_base_upload_dir_message"] = 'Impostare la directory radice per il caricamento dei file per questo utente web nel browser dei file. È possibile utilizzare un percorso assoluto, il segnaposto [(base_path)] o un percorso relativo alla directory di caricamento globale. Lasciare vuoto per utilizzare il valore predefinito del sistema.';
$_lang["image_base_upload_dir_title"] = 'Directory radice caricamento browser file';
...
$_lang["evo_release_title"] = 'Release di Evolution CMS';
$_lang["modx_security_notices"] = 'Avvisi di Protezione EVO';
$_lang["evo_version"] = 'Versione EVO';
$_lang["monday"] = 'Lunedì';
$_lang["move"] = 'Sposta';
...
$_lang["page_data_scheduled_publishdate"] = 'Data di pubblicazione programmata';
$_lang["page_data_scheduled_publishdate_help"] = 'Se imposti una data di pubblicazione programmata, la risorsa sarà pubblicata al raggiungimento di quella data. Lascia vuoto per non pianificare la pubblicazione automatica.';
$_lang["page_data_actual_publishdate"] = 'Data di pubblicazione effettiva';
$_lang["page_data_actual_publishdate_help"] = 'Timestamp in sola lettura salvato in publishedon. Indica quando la risorsa è stata effettivamente pubblicata.';
...
$_lang["rss_url_releases_message"] = 'Inserire l\'URL del feed RSS delle release EVO.';
$_lang["rss_url_releases_title"] = 'Feed RSS delle release EVO';
$_lang["rss_url_extras_default"] = 'https://evo.im/rss/extras.xml';
$_lang["rss_url_extras_message"] = 'Inserire l\'URL del feed RSS degli extra EVO.';
$_lang["rss_url_extras_title"] = 'Feed RSS delle release Extras';
...
$_lang["extras_release_tab"] = 'Release di Evolution CMS Extras';
$_lang["extras_release_title"] = 'Release di Evolution CMS Extras';
...
$_lang["site_timezone_title"] = 'Fuso orario del sito';
$_lang["site_timezone_message"] = 'Seleziona un fuso orario IANA. Viene applicato a PHP e all’applicazione e gestisce automaticamente l’ora legale.';
$_lang["serveroffset_deprecated_message"] = '<b>Deprecato:</b> questo scostamento statico è mantenuto per compatibilità e non considera l’ora legale. Preferisci il fuso orario del sito.';
...
$_lang["tmplvars_binding_msg"] = 'Digita @ per selezionare un binding dati';
...
$_lang["hide_from_tree_title"] = 'Mostra le risorse secondarie';
$_lang["hide_from_tree_help"] = 'Seleziona per mostrare le risorse secondarie nell\'albero del documento';
...
$_lang["bkmgr_snapshot_msg"] = '<p>I contenuti del database vengono salvati e ripristinati da una directory del server.<br />Percorso del salvataggio : [+snapshot_path+] (evo()->getConfig(\'snapshot_path\'))</p>';
...
$_lang["html_comment_title"] = 'Commento HTML';
$_lang["html_comment_message"] = 'Elenco di tipi di elementi separati da virgola da avvolgere con commenti HTML nel sorgente della pagina: <b>snippets</b>, <b>chunks</b>, <b>tvs</b>, <b>snippetParams</b>';
...
$_lang['mail_test_subject'] = 'Messaggio di prova a :destination da :site';
$_lang['mail_test_automated_note'] = 'Questo è un messaggio di prova automatico. Non è richiesta alcuna risposta.';
