...
$_lang["files_download_zip"] = 'הורד ZIP';
$_lang["files_delete_zip"] = 'מחק ZIP';
...
$_lang["image_base_upload_dir_message"] = 'הגדר את ספריית השורש להעלאת קבצים של משתמש אינטרנט זה בדפדפן הקבצים. אתה יכול להשתמש בנתיב מוחלט, בתייבל [(base_path)] או בנתיב יחסי לספריית ההעלאה הגלובלית. השאר ריק כדי להשתמש בברירת המחדל של המערכת.';
$_lang["image_base_upload_dir_title"] = 'ספריית שורש העלאה של דפדפן קבצים';
...
$_lang["evo_release_title"] = 'מהדורות Evolution CMS';
...
$_lang["page_data_scheduled_publishdate"] = 'תאריך פרסום מתוזמן';
$_lang["page_data_scheduled_publishdate_help"] = 'אם תגדיר תאריך פרסום מתוזמן, המשאב יפורסם כאשר תאריך זה יגיע. השאר ריק כדי לא לתזמן פרסום אוטומטי.';
$_lang["page_data_actual_publishdate"] = 'תאריך פרסום בפועל';
$_lang["page_data_actual_publishdate_help"] = 'חותמת זמן לקריאה בלבד השמורה ב-publishedon. היא מציגה מתי המשאב פורסם בפועל.';
...
$_lang["rss_url_releases_message"] = 'הזן את כתובת ה-URL של הזנת ה-RSS של מהדורות EVO.';
$_lang["rss_url_releases_title"] = 'הזנת RSS של מהדורות EVO';
$_lang["rss_url_extras_default"] = 'https://evo.im/rss/extras.xml';
$_lang["rss_url_extras_message"] = 'הזן את כתובת ה-URL של הזנת ה-RSS של תוספי EVO.';
$_lang["rss_url_extras_title"] = 'הזנת RSS של מהדורות Extras';
...
$_lang["extras_release_tab"] = 'מהדורות Evolution CMS Extras';
$_lang["extras_release_title"] = 'מהדורות Evolution CMS Extras';
...
$_lang["site_timezone_title"] = 'אזור הזמן של האתר';
$_lang["site_timezone_message"] = 'בחר אזור זמן של IANA. הוא מוחל על PHP ועל היישום ומתחשב אוטומטית בשעון קיץ.';
$_lang["serveroffset_deprecated_message"] = '<b>הוצא משימוש:</b> ההפרש הקבוע נשמר לתאימות ואינו מתחשב בשעון קיץ. עדיף להשתמש באזור הזמן של האתר.';
...
$_lang["tmplvars_binding_msg"] = 'הקלד @ כדי לבחור קישור נתונים';
...
$_lang['mail_test_subject'] = 'הודעת בדיקה אל :destination מאת :site';
$_lang['mail_test_automated_note'] = 'זוהי הודעת בדיקה אוטומטית. אין צורך להשיב.';
