...
$_lang["files_download_zip"] = 'ZIPをダウンロード';
$_lang["files_delete_zip"] = 'ZIPを削除';
...
$_lang["modules"] = 'モジュール';
$_lang["evo_release_title"] = 'Evolution CMS リリース';
...
$_lang["page_data_scheduled_publishdate"] = '予約公開日時';
$_lang["page_data_scheduled_publishdate_help"] = '予約公開日時を設定すると、その日時にリソースが公開されます。自動公開を予約しない場合は空のままにしてください。';
$_lang["page_data_actual_publishdate"] = '実際の公開日時';
$_lang["page_data_actual_publishdate_help"] = 'publishedon に保存されている読み取り専用の日時です。リソースが実際に公開された日時を示します。';
...
$_lang["rss_url_releases_message"] = 'EVO リリース RSS フィードの URL を入力してください。';
$_lang["rss_url_releases_title"] = 'EVO リリース RSS フィード';
$_lang["rss_url_extras_default"] = 'https://evo.im/rss/extras.xml';
$_lang["rss_url_extras_message"] = 'EVO Extras RSS フィードの URL を入力してください。';
$_lang["rss_url_extras_title"] = 'Extras リリース RSS フィード';
...
$_lang["extras_release_tab"] = 'Evolution CMS Extras リリース';
$_lang["extras_release_title"] = 'Evolution CMS Extras リリース';
...
$_lang["site_timezone_title"] = 'サイトのタイムゾーン';
$_lang["site_timezone_message"] = 'IANAタイムゾーンを選択してください。PHPとアプリケーションに適用され、夏時間も自動的に処理されます。';
$_lang["serveroffset_deprecated_message"] = '<b>非推奨:</b> この固定オフセットは互換性のために残されていますが、夏時間には対応しません。サイトのタイムゾーンを使用してください。';
...
$_lang["tmplvars_binding_msg"] = '@ を入力してデータバインディングを選択';
...
$_lang["hide_from_tree_title"] = '子リソースを表示';
$_lang["hide_from_tree_help"] = 'ドキュメントツリーに子リソースを表示します。';
...
$_lang['mail_test_subject'] = ':site から :destination へのテストメッセージ';
$_lang['mail_test_automated_note'] = 'これは自動テストメッセージです。返信は不要です。';
