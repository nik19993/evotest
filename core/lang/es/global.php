...
$_lang["jit"] = 'JIT';
$_lang["opcache_memory_details"] = '(%s usado / %s disponible), %s aciertos / %s fallos';
$_lang["opcache_reset_unavailable"] = 'restablecimiento no disponible';
$_lang["opcache_reset_complete"] = 'restablecimiento completado';
$_lang["opcache_reset_failed"] = 'restablecimiento fallido';
$_lang["database_name"] = 'Nombre de la base de datos';
$_lang["database_overhead"] = '<b style="color:#990033;">Nota:</b> la sobrecarga es espacio no utilizado reservado por MySQL. Para liberarlo, haz clic en el valor de sobrecarga de la tabla correspondiente.';
...
$_lang["files_download_zip"] = 'Descargar ZIP';
$_lang["files_delete_zip"] = 'Eliminar ZIP';
...
$_lang["image_base_upload_dir_message"] = 'Establece el directorio raíz de carga para este usuario web en el explorador de archivos. Puedes usar una ruta absoluta, el marcador de posición [(base_path)] o una ruta relativa al directorio de carga global. Déjalo vacío para usar el valor predeterminado del sistema.';
$_lang["image_base_upload_dir_title"] = 'Directorio raíz de carga del navegador de archivos';
...
$_lang["evo_release_title"] = 'Lanzamientos de Evolution CMS';
...
$_lang["page_data_scheduled_publishdate"] = 'Fecha de publicación programada';
$_lang["page_data_scheduled_publishdate_help"] = 'Si define una fecha de publicación programada, el recurso se publicará cuando llegue esa fecha. Déjelo vacío para no programar la publicación automática.';
$_lang["page_data_actual_publishdate"] = 'Fecha real de publicación';
$_lang["page_data_actual_publishdate_help"] = 'Marca de tiempo de solo lectura almacenada en publishedon. Indica cuándo se publicó realmente el recurso.';
...
$_lang["rss_url_releases_message"] = 'Ingresa la URL del feed RSS de lanzamientos de EVO.';
$_lang["rss_url_releases_title"] = 'Feed RSS de lanzamientos de EVO';
$_lang["rss_url_extras_default"] = 'https://evo.im/rss/extras.xml';
$_lang["rss_url_extras_message"] = 'Ingresa la URL del feed RSS de complementos de EVO.';
$_lang["rss_url_extras_title"] = 'Feed RSS de lanzamientos de Extras';
...
$_lang["extras_release_tab"] = 'Lanzamientos de Evolution CMS Extras';
$_lang["extras_release_title"] = 'Lanzamientos de Evolution CMS Extras';
...
$_lang["site_timezone_title"] = 'Zona horaria del sitio';
$_lang["site_timezone_message"] = 'Seleccione una zona horaria IANA. Se aplica a PHP y a la aplicación y ajusta automáticamente el horario de verano.';
$_lang["serveroffset_deprecated_message"] = '<b>Obsoleto:</b> este desplazamiento estático se conserva por compatibilidad y no contempla el horario de verano. Use preferentemente la zona horaria del sitio.';
...
$_lang["tmplvars_binding_msg"] = 'Escriba @ para seleccionar una vinculación de datos';
...
$_lang["hide_from_tree_title"] = 'Show child resources';
$_lang["hide_from_tree_help"] = 'Check to show the child resources in the document tree';
...
$_lang['mail_test_help'] = 'Envía un mensaje utilizando el método y la configuración de correo guardados actualmente. No guarda los cambios de esta página.';
$_lang['mail_test_subject'] = 'Mensaje de prueba para :destination desde :site';
$_lang['mail_test_automated_note'] = 'Este es un mensaje de prueba automático. No se requiere respuesta.';
$_lang['mail_test_body'] = "Este es un mensaje de correo de prueba desde :site.\nMétodo de correo: :method\nEnviado el: :time";
$_lang['mail_test_success'] = 'El sistema de correo aceptó el mensaje de prueba mediante :method.';
$_lang['mail_test_method_mail'] = 'PHP mail()';
$_lang['mail_test_method_smtp'] = 'SMTP';
$_lang['mail_test_invalid_destination'] = 'Introduzca una dirección de correo válida para el destinatario.';
$_lang['mail_test_method_not_allowed'] = 'La prueba de correo solo acepta solicitudes POST.';
$_lang['mail_test_unsupported_method'] = 'El método de correo guardado actualmente no se puede probar.';
$_lang['mail_test_debug_mode'] = 'PHP mail() no se puede probar mientras el modo de depuración de Evolution CMS esté activado.';
$_lang['mail_test_csrf_error'] = 'El token de seguridad ha caducado. Recargue la página e inténtelo de nuevo.';
$_lang['mail_test_error'] = 'No se pudo enviar el mensaje de prueba mediante el método de correo guardado actualmente.';
$_lang['mail_test_error_connection'] = 'No se pudo conectar con el servidor SMTP configurado.';
