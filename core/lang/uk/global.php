<?php
/**
 * Evolution CMS Manager language file
 *
 * @version 1.4.5
 * @date 2018/10/31
 * @author The Evolution CMS Project Team
 *
 * @language Ukraine
 * @package evo
 * @subpackage manager
...
$_lang["access_permissions_docs_collision"] = 'Оскільки групи веб-користувачів і менеджерів конфліктують з вашою роллю, цей ресурс буде доступний для всіх.';
$_lang["access_permissions_docs_message"] = 'Тут ви можете вибрати, до яких груп ресурсів належить цей ресурс.';
$_lang["access_permissions_group_link"] = 'Створити новий зв\'язок групи користувачів і групи ресурсів';
...
$_lang["activity_message"] = 'Цей список показує нещодавно створені або відредаговані ресурси:';
...
$_lang["automatic_alias_message"] = 'Оберіть \'Так\' для того, щоб система автоматично генерувала псевдоніми на основі заголовків сторінок.';
...
$_lang["configcheck_cache_msg"] = 'Evolution CMS не в змозі записувати дані в папку кешування. Система буде працювати нормально, але кешування відбуватися не буде. Для вирішення проблеми дозвольте запис у папку <b>/assets/cache</b>.';
...
$_lang["configcheck_filemanager_path_msg"] = 'Це може статися, наприклад, після переміщення вашого сайту в інший каталог або на інший сервер. Будь ласка, перевірте і оновіть налаштування вашої системи EvolutionCMS';
...
$_lang["configcheck_lang_difference"] = 'Неправильна кількість записів в мовному пакеті.';
$_lang["configcheck_lang_difference_msg"] = 'Поточний мовний пакет має кількість записів, відмінний від необхідного. Незважаючи на те, що система буде працювати нормально, можливо, мовний пакет потребує доопрацювання.'; //*
$_lang["configcheck_notok"] = 'Конфігурація містить помилки.';
$_lang["configcheck_ok"] = 'Конфігурація не містить помилок.';
$_lang["configcheck_php_gdzip"] = 'GD і/або Zip PHP розширення не знайдено';
$_lang["configcheck_php_gdzip_msg"] = 'Для нормальної роботи Evolution CMS необхідно, щоб були дозволені GD і Zip розширення для PHP. EVO буде працювати і без цих розширень, але ви не зможете використовувати всі можливості вбудованого файл-менеджера, редактора зображень або код CAPTCHA для авторизації.';
$_lang["configcheck_rb_base_dir"] = 'Введено невірний <a href="index.php?a=17&tab=6">шлях для файл-браузера</a>';
$_lang["configcheck_rb_base_dir_msg"] = 'Це може статися, наприклад, після переміщення вашого сайту в інший каталог або на інший сервер. Будь ласка, перевірте і оновіть налаштування вашої системи EvolutionCMS';
...
$_lang["delete_yourself"] = 'Ви не можете видалити себе';
$_lang["delete_last_admin"] = 'Ви не можете видалити останнього адміністратора';
$_lang["confirm_delete_permission"] = 'Ви впевнені, що хочете видалити це право доступу?';
...
$_lang["confirm_remove_locks"] = 'Користувачі іноді закривають браузер в процесі редагування ресурсів, шаблонів, сніпетів і т.д., залишаючи їх заблокованими. Натискаючи \'ОК\', ви видаляєте всі поточні блокування. \n\nПродовжити?';
...
$_lang["confirm_unpublish"] = '\n\nСкасування публікації цього ресурсу зараз видалить всі встановлені розклади публікації. Якщо ви хочете встановити новий розклад або залишити старий - виберіть пункт \'Редагувати\'.\nПродовжити?';
...
$_lang["credits_shouts_msg"] = '<p>Evolution CMS підтримується на сайті <a href="https://evo.im/" target="_blank">evo.im</a>.</p>';
$_lang["custom_contenttype_message"] = 'Тут ви можете додати типи вмісту (Content-Type) для сайту. Для цього введіть тип вмісту і натисніть \'Додати\'.';
...
$_lang["database_overhead"] = '<b style="color:#990033;">Примітка:</b> надлишок — це невикористаний простір, зарезервований MySQL. Щоб звільнити його, натисніть значення надлишку для відповідної таблиці.';
...
$_lang["database_table_overhead"] = 'Надлишок';
...
$_lang["duplicate_template_alias_found"] = 'Шаблон <b>%s</b> вже використовує псевдонім <b>%s</b>. Введіть унікальний псевдонім.';
...
$_lang["duplicate_name_found_module"] = 'Модуль з ім\'ям <b>%s</b> вже існує. Будь ласка, введіть інше ім\'я.';
...
$_lang["email"] = 'E-mail';
$_lang["email_unique"] = 'Цей Email вже зайнято!';
...
$_lang["error"] = 'Помилка';
$_lang["error_sending_email"] = 'Помилка відправки e-mail';
...
$_lang["fe_editor_lang_message"] = 'Оберіть мову редактора, який буде використовуватися у фронтенді.';
...
$_lang["files_download_zip"] = 'Скачати ZIP';
$_lang["files_delete_zip"] = 'Видалити ZIP';
$_lang["files_zip_in_progress"] = 'ZIP-архів уже створюється або залишився після попереднього запиту. Видаліть його перед новим скачуванням.';
$_lang["files_zip_deleted"] = 'ZIP-архів видалено.';
$_lang["files_zip_failed"] = 'Не вдалося створити ZIP-архів.';
$_lang["files_zip_unavailable"] = 'Скачування ZIP недоступне для цього каталогу.';
...
$_lang["image_base_upload_dir_message"] = 'Вкажіть кореневий каталог завантаження для цього веб-користувача у файл-браузері. Можна використовувати абсолютний шлях, плейсхолдер [(base_path)] або шлях відносно глобального каталогу завантаження. Залиште порожнім, щоб використовувати системне значення.';
$_lang["image_base_upload_dir_title"] = 'Кореневий каталог завантаження файл-браузера:';
...
$_lang["files_dirwritable"] = 'Чи дозволено запис у папку?';
...
$_lang["files_filetype_notok"] = 'Завантаження файлів такого типу заборонене';
...
$_lang["files_uploadfile"] = 'Завантажити файл на сервер';
$_lang["files_uploadfile_msg"] = 'Оберіть файли для завантаження на сервер:';
...
$_lang["friendly_alias_message"] = 'Якщо сайт використовує дружні URL, і ресурс має псевдонім, то при включенні цього параметра URL ресурсу матиме вигляд: \'http://mysite.com/псевдонім\'. Якщо визначені суфікс (наприклад \'.html\') і / або префікс (наприклад \'page-\') дружніх URL, адреса сторінки буде наступною: \'http://mysite.com/page-псевдонім.html\'. Якщо не задані псевдоніми, суфікси і префікси, EVO згенерує такий URL: \'http://mysite.com/2\', де 2 - ID ресурсу.';
$_lang["friendly_alias_title"] = 'Використовувати псевдоніми в URL:';
$_lang["friendlyurls_message"] = 'Даний параметр дозволяє використання дружніх URL на сайті. Пам\'ятайте, що дана можливість доступна лише тоді, коли EVO працює на сервері Apache з встановленим mod_rewrite; крім того, необхідно змінити файл .htaccess. Для інформації по докладним налаштувань подивіться файл .htaccess, що входить в дистрибутив EVO.';
...
$_lang["help_msg"] = '<p>Ви можете отримати безкоштовну Допомогу спільноти EVO <a href="https://evo.im" target="_blank">на форумах EVO</a>. Дивіться також <a href="https://docs.evo.im" target="_blank">\'Документація та уроки по EVO\'</a>, де докладно описано кожен аспект системи.</p>';
...
$_lang["update_tree"] = 'Перебудувати дерево';
$_lang["update_tree_description"] = '<ul>
                    <li>- Closure table патерн проєктування Бази даних, що робить більш зручною та швидкою роботу з деревом документів</li>
                    <li>- Якщо дані в дереві оновлюються не через models, то є вірогідність не корректної зв\'язки документів в базі</li>
                    <li>- Ця операція виправляє проблему, коли site_content оновлюється не через модель (save,create) та не оновлюються зв\'язки (Closure table)</li>
                    <li>- Також можливо виконати дану операцію в режимі CLI через команду \'php artisan closuretable:rebuild\'</li>
                </ul>';
$_lang["update_tree_danger"] = 'Якщо у вас більше 1000 ресурсів, краще виконати дану операцію в режиме CLI через команду \'php artisan closuretable:rebuild\'';
$_lang["update_tree_time"] = 'Оновлення дерева завершено.<br> Документів оброблено: <b>%s</b><br>Процес зайняло <b>%s</b> секунд.';
$_lang["inbox"] = 'Вхідні';
...
$_lang["lock_msg"] = '<b>%s</b> зараз редагує <b>%s</b>. Будь ласка, зачекайте, поки інший користувач закінчить з редагуванням, і спробуйте знову.';
...
$_lang["evo_release_title"] = 'Релізи Evolution CMS';
$_lang["modx_security_notices"] = 'Повідомлення безпеки Evolution CMS';
...
$_lang["page_data_scheduled_publishdate"] = 'Запланована дата публікації';
$_lang["page_data_scheduled_publishdate_help"] = 'Якщо встановити заплановану дату публікації, ресурс буде опубліковано після настання цієї дати. Залиште поле порожнім, щоб не планувати автоматичну публікацію.';
$_lang["page_data_actual_publishdate"] = 'Фактична дата публікації';
$_lang["page_data_actual_publishdate_help"] = 'Поле лише для читання зі значенням publishedon. Показує, коли ресурс фактично було опубліковано.';
...
$_lang["password_gen_gen"] = 'Дозволити Evolution CMS згенерувати пароль.';
...
$_lang["password_confirmed"] = 'Дані, що введено в поля "Пароль" і "Повторіть пароль", повинні збігатися';
$_lang["password_msg"] = 'Для користувача <b>:username</b> заданий новий пароль - <b>:password</b><br>';
$_lang["php_version_check"] = 'Evolution CMS працює з PHP версії 8.0.2 або вище. Будь ласка, поновіть PHP';
$_lang["plugin"] = 'Плагін';
...
$_lang["required_field"] = 'Поле :field обов\'язково';
...
$_lang["resource_alias_help"] = 'Тут ви можете обрати псевдонім (alias) для ресурсу. Псевдонім ресурсу дозволяє звертатися до ресурсу за адресою: https://example.com/alias/. Увага: функція буде працювати тільки при включених «дружніх URL».';
...
$_lang["role_widget_online_info"] = 'Перегляд віджета «Користувачі онлайн»';
...
$_lang["rss_url_releases_message"] = 'Введіть адресу (URL) RSS-смужки релізів EVO.';
$_lang["rss_url_releases_title"] = 'Смужка RSS релізів EVO';
$_lang["rss_url_extras_default"] = 'https://evo.im/rss/extras.xml';
$_lang["rss_url_extras_message"] = 'Введіть адресу (URL) RSS-смужки доповнень EVO.';
$_lang["rss_url_extras_title"] = 'Смужка RSS релізів Extras';
...
$_lang["extras_release_tab"] = 'Релізи Evolution CMS Extras';
$_lang["extras_release_title"] = 'Релізи Evolution CMS Extras';
...
$_lang["site_timezone_title"] = 'Часовий пояс сайту';
$_lang["site_timezone_message"] = 'Виберіть часовий пояс IANA. Він застосовується до PHP і застосунку та автоматично враховує літній час.';
$_lang["serveroffset_deprecated_message"] = '<b>Застаріле:</b> це статичне зміщення збережене для сумісності й не враховує літній час. Надавай перевагу часовому поясу сайту.';
...
$_lang["settings_strip_image_paths_message"] = 'Якщо цей параметр увімкнено, Evolution CMS буде використовувати відносні посилання для зображень, файлів, анімації тощо. Відносні посилання зручніші, якщо ви в майбутньому збираєтеся перемістити свій сайт, наприклад, з тестового сервера на кінцевий. Якщо ви не знаєте, про що мова, залиште значення \'Так\'.';
$_lang["settings_strip_image_paths_title"] = 'Обрізати шляхи до зображень';
...
$_lang["settings_email_templates"] = 'Пошта й шаблони';
...
$_lang["controller_namespace_message"] = 'Вкажіть повний Namespace з якого варто брати контролери, наприклад: <b>EvolutionCMS\\Main\\Controllers\\</b>';
$_lang["update_repository"] = 'Git Hub шлях';
$_lang["update_repository_message"] = 'Введіть шлях до Git Hub репозиторію, наприклад: <b>evolution-cms/evolution</b>';
...
$_lang["snippet_management_msg"] = '<b>Сніпети</b> - це чистий PHP-код, що забезпечує динамічну логіку. Сніпети дозволяють відокремити бізнес-логіку від структури і представлення даних на веб-сторінці. Вони можуть використовуватися для генерації динамічних меню, виведення контенту з бази даних за певною умовою (наприклад, тільки для зареєстрованих користувачів), взагалі, для будь-яких дій, доступних через EVO API. Сніпети можуть (але не зобов\'язані) приймати параметри і виводити якийсь результат (наприклад, генерувати HTML-код).<p/><p><b>Використання:</b> вставте <code>[[snippetName]]</code> або <code>[!snippetName!]</code> де-небудь в <i>шаблоні</i>, в <i>області контента</i>, в <i>чанку</i> або в <i>параметрі (TV)</i>. Формат <code>[[snippetName]]</code> дозволяє кешування результатів виконання сніпета, якщо для сторінки включено кешування. Формат <code>[!snippetName!]</code> використовується для виконання PHP-коду сніпета при кожному Перегляд сторінки, навіть якщо для сторінки дозволено кешування. Щоб при виклику PHP-коду сніпета передати в нього параметри, використовуйте формат <code>[[snippetName? &amp;param1=\'value1\' &amp;param2=\'value2\' .. &amp;paramN=\'valueN\']]</code> (або <code>[!snippetName? &amp;param1=\'value1\' &amp;param2=\'value2\' .. &amp;paramN=\'valueN\'!]</code>). Як параметри виклику сніпета можна використовувати виклик інших фрагментів (також з параметрами) або <i>чанків</i>.</p><p><b>Виклик через EVO API:</b> <code>$modx->runSnippet(\'snippetName\');</code></p><p><br /> Виберіть сніпет для редагування або створіть новий.';
...
$_lang["template_reset_specific"] = 'Скинути тільки сторінки з шаблоном <b>%s</b>';
...
$_lang["tmplvars_binding_msg"] = 'Введіть @, щоб вибрати прив’язку даних';
...
$_lang["track_visitors_title"] = 'Облік відвідувань';
$_lang["hide_from_tree_title"] = 'Показувати дочірні ресурси';
$_lang["hide_from_tree_help"] = 'Відзначте, щоб показувати дочірні ресурси в дереві документів';
...
$_lang["username_unique"] = 'Це ім\'я користувача вже зайнято!';
...
$_lang["enable_bindings_message"] = 'Запобігає виконання PHP-коду через використання @-прив\'язок в TV-параметрах. Потрібно, якщо у вас є користувачі, які не повинні мати можливість створювати PHP-код, але можуть створювати або редагувати TV-параметри. При спробі виводу будь-якого TV-параметра з @-прив\'язкою буде показано повідомлення "@-прив\'язки заборонені".';
...
$_lang["disable_plugins_cache_title"] = 'Вимкнути кешування плагінів';
...
$_lang["html_comment_message"] = 'Список типів елементів через кому для обгортання HTML-коментарями у вихідному коді сторінки: <b>snippets</b>, <b>chunks</b>, <b>tvs</b>, <b>snippetParams</b>';
...
$_lang["error_no_privileges"]         = "У вас не вистачає привілеїв для цієї дії!";
...
$_lang["error_parent_deleted"]        = "Не вдалося виконати, тому що батьківський ресурс помічено як видалений!";
...
$_lang['invalid_event_response'] = 'Подія <b>%s</b> повернула невірний результат';
$_lang['chunk_processor'] = 'Клас обробки чанків';
...
$_lang['eventlog_mail_sent'] = 'Лист відправлено';
$_lang['eventlog_system_user'] = 'Система';
...
$_lang['mail_test_subject'] = 'Тестове повідомлення на :destination із сайту :site';
$_lang['mail_test_body'] = "Це тестове поштове повідомлення із сайту :site.\nПоштовий метод: :method\nЧас відправлення: :time";
$_lang['mail_test_automated_note'] = 'Це автоматичне тестове повідомлення. Відповідати на нього не потрібно.';
