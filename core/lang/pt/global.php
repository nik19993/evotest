...
$_lang["files_download_zip"] = 'Baixar ZIP';
$_lang["files_delete_zip"] = 'Excluir ZIP';
...
$_lang["image_base_upload_dir_message"] = 'Defina o diretório raiz de upload de arquivo para este usuário da web no navegador de arquivos. Você pode usar um caminho absoluto, o espaço reservado [(base_path)] ou um caminho relativo ao diretório de upload global. Deixe em branco para usar o padrão do sistema.';
$_lang["image_base_upload_dir_title"] = 'Diretório raiz de upload do navegador de arquivos';
...
$_lang["evo_release_title"] = 'Lançamentos do Evolution CMS';
...
$_lang["page_data_scheduled_publishdate"] = 'Data de publicação agendada';
$_lang["page_data_scheduled_publishdate_help"] = 'Se definir uma data de publicação agendada, o recurso será publicado quando essa data for atingida. Deixe vazio para não agendar publicação automática.';
$_lang["page_data_actual_publishdate"] = 'Data real de publicação';
$_lang["page_data_actual_publishdate_help"] = 'Carimbo de data/hora somente leitura armazenado em publishedon. Mostra quando o recurso foi realmente publicado.';
...
$_lang["rss_url_releases_message"] = 'Insira o URL do feed RSS de lançamentos EVO.';
$_lang["rss_url_releases_title"] = 'Feed RSS de lançamentos EVO';
$_lang["rss_url_extras_default"] = 'https://evo.im/rss/extras.xml';
$_lang["rss_url_extras_message"] = 'Insira o URL do feed RSS de extras EVO.';
$_lang["rss_url_extras_title"] = 'Feed RSS de lançamentos Extras';
...
$_lang["extras_release_tab"] = 'Lançamentos do Evolution CMS Extras';
$_lang["extras_release_title"] = 'Lançamentos do Evolution CMS Extras';
...
$_lang["site_timezone_title"] = 'Fuso horário do site';
$_lang["site_timezone_message"] = 'Selecione um fuso horário IANA. Ele é aplicado ao PHP e à aplicação e ajusta automaticamente o horário de verão.';
$_lang["serveroffset_deprecated_message"] = '<b>Obsoleto:</b> este desvio estático é mantido por compatibilidade e não considera o horário de verão. Prefira o fuso horário do site.';
...
$_lang["tmplvars_binding_msg"] = 'Digite @ para selecionar uma ligação de dados';
...
$_lang['eventlog_mail_sent'] = 'E-mail enviado';
...
$_lang['mail_test_subject'] = 'Mensagem de teste para :destination de :site';
$_lang['mail_test_automated_note'] = 'Esta é uma mensagem de teste automática. Não é necessária resposta.';
