...
$_lang["files_download_zip"] = 'دانلود ZIP';
$_lang["files_delete_zip"] = 'حذف ZIP';
...
$_lang["image_base_upload_dir_message"] = 'دایرکتوری ریشه برای آپلود فایل این کاربر وب را در مرورگر فایل تعیین کنید. می‌توانید از یک مسیر مطلق، نشانگر [(base_path)] یا مسیری نسبت به دایرکتوری آپلود جهانی استفاده کنید. برای استفاده از پیش‌فرض سیستم خالی بگذارید.';
$_lang["image_base_upload_dir_title"] = 'دایرکتوری ریشه آپلود مرورگر فایل';
...
$_lang["evo_release_title"] = 'انتشارهای Evolution CMS';
...
$_lang["page_data_scheduled_publishdate"] = 'تاریخ انتشار زمان‌بندی‌شده';
$_lang["page_data_scheduled_publishdate_help"] = 'اگر تاریخ انتشار زمان‌بندی‌شده را تنظیم کنید، منبع هنگام رسیدن آن تاریخ منتشر می‌شود. برای عدم انتشار خودکار، خالی بگذارید.';
$_lang["page_data_actual_publishdate"] = 'تاریخ انتشار واقعی';
$_lang["page_data_actual_publishdate_help"] = 'برچسب زمانی فقط‌خواندنی ذخیره‌شده در publishedon. نشان می‌دهد منبع واقعاً چه زمانی منتشر شده است.';
...
$_lang["rss_url_releases_message"] = 'نشانی URL خوراک RSS انتشارهای EVO را وارد کنید.';
$_lang["rss_url_releases_title"] = 'خوراک RSS انتشارهای EVO';
$_lang["rss_url_extras_default"] = 'https://evo.im/rss/extras.xml';
$_lang["rss_url_extras_message"] = 'نشانی URL خوراک RSS افزونه‌های EVO را وارد کنید.';
$_lang["rss_url_extras_title"] = 'خوراک RSS انتشارهای Extras';
...
$_lang["extras_release_tab"] = 'انتشارهای Evolution CMS Extras';
$_lang["extras_release_title"] = 'انتشارهای Evolution CMS Extras';
...
$_lang["site_timezone_title"] = 'منطقه زمانی سایت';
$_lang["site_timezone_message"] = 'یک منطقه زمانی IANA انتخاب کنید. این مقدار برای PHP و برنامه اعمال می‌شود و ساعت تابستانی را خودکار در نظر می‌گیرد.';
$_lang["serveroffset_deprecated_message"] = '<b>منسوخ:</b> این اختلاف ثابت برای سازگاری حفظ شده و ساعت تابستانی را در نظر نمی‌گیرد. از منطقه زمانی سایت استفاده کنید.';
...
$_lang["tmplvars_binding_msg"] = 'برای انتخاب اتصال داده @ را تایپ کنید';
...
$_lang['mail_test_subject'] = 'پیام آزمایشی به :destination از :site';
$_lang['mail_test_automated_note'] = 'این یک پیام آزمایشی خودکار است. نیازی به پاسخ نیست.';
