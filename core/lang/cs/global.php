...
$_lang["database_overhead"] = '<b style="color:#990033;">Poznámka:</b> Režie je nevyužité místo rezervované MySQL. Chcete-li ho uvolnit, klikněte na hodnotu režie u příslušné tabulky.';
...
$_lang["database_table_overhead"] = 'Režie';
...
$_lang["files_download_zip"] = 'Stáhnout ZIP';
$_lang["files_delete_zip"] = 'Smazat ZIP';
...
$_lang["image_base_upload_dir_message"] = 'Nastavte kořenový adresář pro nahrávání souborů pro tohoto webového uživatele v prohlížeči souborů. Můžete použít absolutní cestu, zástupný text [(base_path)] nebo cestu relativní ke globálnímu adresáři pro nahrávání. Ponechte prázdné pro použití výchozího systému.';
$_lang["image_base_upload_dir_title"] = 'Kořenový adresář nahrávání prohlížeče souborů';
...
$_lang["evo_release_title"] = 'Vydání Evolution CMS';
...
$_lang["page_data_scheduled_publishdate"] = 'Naplánované datum publikování';
$_lang["page_data_scheduled_publishdate_help"] = 'Pokud nastavíte naplánované datum publikování, zdroj bude publikován po dosažení tohoto data. Ponechte prázdné, pokud nechcete plánovat automatické publikování.';
$_lang["page_data_actual_publishdate"] = 'Skutečné datum publikování';
$_lang["page_data_actual_publishdate_help"] = 'Časové razítko jen pro čtení uložené v publishedon. Ukazuje, kdy byl zdroj skutečně publikován.';
...
$_lang["rss_url_releases_message"] = 'Zadejte URL adresu RSS kanálu vydání EVO.';
$_lang["rss_url_releases_title"] = 'RSS kanál vydání EVO';
$_lang["rss_url_extras_default"] = 'https://evo.im/rss/extras.xml';
$_lang["rss_url_extras_message"] = 'Zadejte URL adresu RSS kanálu doplňků EVO.';
$_lang["rss_url_extras_title"] = 'RSS kanál vydání Extras';
...
$_lang["extras_release_tab"] = 'Vydání Evolution CMS Extras';
$_lang["extras_release_title"] = 'Vydání Evolution CMS Extras';
...
$_lang["site_timezone_message"] = 'Vyberte časové pásmo IANA. Použije se pro PHP i aplikaci a automaticky zohledňuje letní čas.';
$_lang["serveroffset_deprecated_message"] = '<b>Zastaralé:</b> tento pevný posun zůstává kvůli kompatibilitě a nezohledňuje letní čas. Upřednostněte časové pásmo webu.';
...
$_lang["tmplvars_binding_msg"] = 'Zadejte @ pro výběr vazby dat';
...
$_lang['mail_test_subject'] = 'Testovací zpráva pro :destination z webu :site';
$_lang['mail_test_automated_note'] = 'Toto je automatická testovací zpráva. Odpověď není nutná.';
