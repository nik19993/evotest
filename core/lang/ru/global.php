...
$_lang["database_overhead"] = '<b style="color:#990033;">Примечание:</b> избыточное пространство — это неиспользуемое место, зарезервированное MySQL. Чтобы освободить его, нажмите значение избыточного пространства для соответствующей таблицы.';
...
$_lang["database_table_overhead"] = 'Избыточное пространство';
...
$_lang["duplicate_name_found_general"] = 'Объект <b>%s</b> с именем <b>%s</b> уже существует. Пожалуйста, введите другое имя.';
$_lang["duplicate_name_found_module"] = 'Модуль с именем <b>%s</b> уже существует. Пожалуйста, введите другое имя.';
...
$_lang["files_download_zip"] = 'Скачать ZIP';
$_lang["files_delete_zip"] = 'Удалить ZIP';
$_lang["files_zip_in_progress"] = 'ZIP-архив уже создается или остался после предыдущего запроса. Удалите его перед новым скачиванием.';
$_lang["files_zip_deleted"] = 'ZIP-архив удален.';
$_lang["files_zip_failed"] = 'Не удалось создать ZIP-архив.';
$_lang["files_zip_unavailable"] = 'Скачивание ZIP недоступно для этого каталога.';
...
$_lang["image_base_upload_dir_message"] = 'Укажите корневой каталог загрузки для этого веб-пользователя в файловом браузере. Можно использовать абсолютный путь, плейсхолдер [(base_path)] или путь относительно глобального каталога загрузки. Оставьте поле пустым, чтобы использовать системное значение.';
$_lang["image_base_upload_dir_title"] = 'Корневой каталог загрузки файл-браузера:';
...
$_lang["files_management_no_permission"] = 'У вас недостаточно прав для просмотра или редактирования этих файлов. Обратитесь к администратору, чтобы предоставить вам доступ к <b>%s</b>.';
...
$_lang["files_upload_inhibited_msg"] = '<b>Функция загрузки файлов на сервер недоступна</b> - убедитесь, что папка доступна PHP для записи.';
$_lang["files_upload_ok"] = 'Файл успешно загружен';
$_lang["files_upload_permissions_error"] = 'Возможно ошибка прав доступа - папка, в которую вы хотите загрузить данные, недоступна для записи на вашем сервере.';
$_lang["files_uploadfile"] = 'Загрузить файл на сервер';
$_lang["files_uploadfile_msg"] = 'Выберите файлы для загрузки на сервер:';
...
$_lang["evo_release_title"] = 'Релизы Evolution CMS';
...
$_lang["page_data_scheduled_publishdate"] = 'Запланированная дата публикации';
$_lang["page_data_scheduled_publishdate_help"] = 'Если установить запланированную дату публикации, ресурс будет опубликован при наступлении этой даты. Оставьте поле пустым, чтобы не планировать автоматическую публикацию.';
$_lang["page_data_actual_publishdate"] = 'Фактическая дата публикации';
$_lang["page_data_actual_publishdate_help"] = 'Поле только для чтения со значением publishedon. Показывает, когда ресурс фактически был опубликован.';
...
$_lang["rss_url_releases_message"] = 'Введите URL-адрес RSS-ленты релизов EVO.';
$_lang["rss_url_releases_title"] = 'Лента RSS релизов EVO';
$_lang["rss_url_extras_default"] = 'https://evo.im/rss/extras.xml';
$_lang["rss_url_extras_message"] = 'Введите URL-адрес RSS-ленты дополнений EVO.';
$_lang["rss_url_extras_title"] = 'Лента RSS релизов Extras';
...
$_lang["extras_release_tab"] = 'Релизы Evolution CMS Extras';
$_lang["extras_release_title"] = 'Релизы Evolution CMS Extras';
...
$_lang["site_timezone_title"] = 'Часовой пояс сайта';
$_lang["site_timezone_message"] = 'Выберите часовой пояс IANA. Он применяется к PHP и приложению и автоматически учитывает переход на летнее время.';
$_lang["serveroffset_deprecated_message"] = '<b>Устарело:</b> это статическое смещение сохранено для совместимости и не учитывает летнее время. Используйте часовой пояс сайта.';
...
$_lang["tmplvars_binding_msg"] = 'Введите @, чтобы выбрать привязку данных';
...
$_lang["track_visitors_title"] = 'Учет посещений';
$_lang["hide_from_tree_title"] = 'Показывать дочерние ресурсы';
$_lang["hide_from_tree_help"] = 'Отметьте, чтобы показывать дочерние ресурсы в дереве документов';
...
$_lang['eventlog_mail_sent'] = 'Письмо отправлено';
$_lang['eventlog_system_user'] = 'Система';
$_lang['mail_test_title'] = 'Тестовое почтовое сообщение';
$_lang['mail_test_destination'] = 'Email получателя';
$_lang['mail_test_send'] = 'Отправить тест';
$_lang['mail_test_help'] = 'Отправляет одно сообщение через текущий сохранённый почтовый метод и его настройки. Изменения на этой странице не сохраняются.';
$_lang['mail_test_subject'] = 'Тестовое сообщение для :destination с сайта :site';
$_lang['mail_test_automated_note'] = 'Это автоматическое тестовое сообщение. Отвечать на него не нужно.';
$_lang['mail_test_body'] = "Это тестовое почтовое сообщение с сайта :site.\nПочтовый метод: :method\nВремя отправки: :time";
$_lang['mail_test_success'] = 'Почтовая система приняла тестовое сообщение через :method.';
$_lang['mail_test_method_mail'] = 'PHP mail()';
$_lang['mail_test_method_smtp'] = 'SMTP';
$_lang['mail_test_invalid_destination'] = 'Введите корректный email-адрес получателя.';
$_lang['mail_test_method_not_allowed'] = 'Тест почты принимает только POST-запросы.';
$_lang['mail_test_unsupported_method'] = 'Текущий сохранённый почтовый метод невозможно проверить.';
$_lang['mail_test_debug_mode'] = 'PHP mail() невозможно проверить, пока включён режим отладки Evolution CMS.';
$_lang['mail_test_csrf_error'] = 'Срок действия защитного токена истёк. Обновите страницу и повторите попытку.';
$_lang['mail_test_error'] = 'Не удалось отправить тестовое сообщение через текущий сохранённый почтовый метод.';
$_lang['mail_test_error_connection'] = 'Не удалось подключиться к настроенному SMTP-серверу.';
