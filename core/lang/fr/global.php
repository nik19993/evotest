...
$_lang["database_overhead"] = '<b style="color:#990033;">Note :</b> l\'espace excédentaire est un espace inutilisé réservé par MySQL. Pour le libérer, cliquez sur la valeur d\'espace excédentaire de la table concernée.';
...
$_lang["database_table_overhead"] = 'Espace excédentaire';
...
$_lang["files_download_zip"] = 'Télécharger le ZIP';
$_lang["files_delete_zip"] = 'Supprimer le ZIP';
$_lang["files_zip_in_progress"] = 'Une archive ZIP est deja en cours de creation ou reste une demande precedente. Supprimez-la avant de lancer un nouveau telechargement.';
$_lang["files_zip_deleted"] = 'Archive ZIP supprimee.';
$_lang["files_zip_failed"] = 'Impossible de creer archive ZIP.';
$_lang["files_zip_unavailable"] = 'Le telechargement ZIP est indisponible pour ce dossier.';
...
$_lang["image_base_upload_dir_message"] = 'Définissez le répertoire racine de téléchargement de fichiers pour cet utilisateur web dans le navigateur de fichiers. Vous pouvez utiliser un chemin absolu, l\'espace réservé [(base_path)] ou un chemin relatif au répertoire de téléchargement global. Laissez vide pour utiliser la valeur par défaut du système.';
$_lang["image_base_upload_dir_title"] = 'Répertoire racine de téléchargement du navigateur de fichiers';
...
$_lang["files_uploadfile"] = 'Téléverser un fichier';
$_lang["files_uploadfile_msg"] = 'Sélectionnez un fichier à téléverser:';
...
$_lang["evo_release_title"] = 'Versions d\'Evolution CMS';
$_lang["modx_security_notices"] = 'Bulletins de sécurité MODX';
$_lang["evo_version"] = 'Version de MODX';
$_lang["monday"] = 'Lundi';
$_lang["move"] = 'Déplacer';
...
$_lang["page_data_scheduled_publishdate"] = 'Date de publication planifiée';
$_lang["page_data_scheduled_publishdate_help"] = 'Si vous définissez une date de publication planifiée, la ressource sera publiée lorsque cette date sera atteinte. Laissez vide pour ne pas planifier de publication automatique.';
$_lang["page_data_actual_publishdate"] = 'Date de publication réelle';
$_lang["page_data_actual_publishdate_help"] = 'Horodatage en lecture seule stocké dans publishedon. Il indique quand la ressource a réellement été publiée.';
...
$_lang["rss_url_releases_message"] = 'Entrez l\'URL du flux RSS des versions EVO.';
$_lang["rss_url_releases_title"] = 'Flux RSS des versions EVO';
$_lang["rss_url_extras_default"] = 'https://evo.im/rss/extras.xml';
$_lang["rss_url_extras_message"] = 'Entrez l\'URL du flux RSS des modules complémentaires EVO.';
$_lang["rss_url_extras_title"] = 'Flux RSS des versions Extras';
...
$_lang["extras_release_tab"] = 'Versions d\'Evolution CMS Extras';
$_lang["extras_release_title"] = 'Versions d\'Evolution CMS Extras';
...
$_lang["site_timezone_title"] = 'Fuseau horaire du site';
$_lang["site_timezone_message"] = 'Sélectionnez un fuseau horaire IANA. Il est appliqué à PHP et à l’application et gère automatiquement l’heure d’été.';
$_lang["serveroffset_deprecated_message"] = '<b>Obsolète :</b> ce décalage statique est conservé pour compatibilité et ne tient pas compte de l’heure d’été. Préférez le fuseau horaire du site.';
...
$_lang["tmplvars_binding_msg"] = 'Saisissez @ pour sélectionner une liaison de données';
...
$_lang['mail_test_subject'] = 'Message de test à :destination depuis :site';
$_lang['mail_test_automated_note'] = 'Ceci est un message de test automatique. Aucune réponse n’est nécessaire.';
