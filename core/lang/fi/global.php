...
$_lang["jit"] = 'JIT';
$_lang["opcache_memory_details"] = '(%s käytössä / %s käytettävissä), %s osumaa / %s huteja';
$_lang["opcache_reset_unavailable"] = 'nollaus ei ole käytettävissä';
$_lang["opcache_reset_complete"] = 'nollaus valmis';
$_lang["opcache_reset_failed"] = 'nollaus epäonnistui';
$_lang["database_name"] = 'Tietokannan nimi';
$_lang["database_overhead"] = '<strong>Huomaa:</strong> hukkatila on MySQL:n varaamaa käyttämätöntä tilaa. Vapauta tila napsauttamalla kyseisen taulun hukkatilan arvoa.';
...
$_lang["files_download_zip"] = 'Lataa ZIP';
$_lang["files_delete_zip"] = 'Poista ZIP';
$_lang["files_zip_in_progress"] = 'ZIP-arkistoa luodaan jo tai se jai aiemmasta pyynnosta. Poista se ennen uutta latausta.';
$_lang["files_zip_deleted"] = 'ZIP-arkisto poistettiin.';
$_lang["files_zip_failed"] = 'ZIP-arkiston luonti epaonnistui.';
$_lang["files_zip_unavailable"] = 'ZIP-lataus ei ole kaytettavissa talle kansiolle.';
...
$_lang["image_base_upload_dir_message"] = 'Aseta tämän web-käyttäjän tiedostojen lataushakem tiedoston selaimen juureen. Voit käyttää absoluuttista polkua, [(base_path)] -paikkamerkkiä tai polkua suhteessa globaaliin latauskansioon. Jätä tyhjäksi käyttääksesi järjestelmän oletusarvoa.';
$_lang["image_base_upload_dir_title"] = 'Tiedostoselaimen lataus juurihakemisto';
...
$_lang["files_uploadfile"] = 'Lähetä tiedosto';
$_lang["files_uploadfile_msg"] = 'Valitse lähetettävä tiedosto:';
...
$_lang["evo_release_title"] = 'Evolution CMS -julkaisut';
...
$_lang["page_data_scheduled_publishdate"] = 'Ajastettu julkaisupäivä';
$_lang["page_data_scheduled_publishdate_help"] = 'Jos asetat ajastetun julkaisupäivän, resurssi julkaistaan kyseisenä ajankohtana. Jätä tyhjäksi, jos et halua ajastaa automaattista julkaisua.';
$_lang["page_data_actual_publishdate"] = 'Todellinen julkaisupäivä';
$_lang["page_data_actual_publishdate_help"] = 'Vain luku -aikaleima kentästä publishedon. Se näyttää, milloin resurssi oikeasti julkaistiin.';
...
$_lang["rss_url_releases_message"] = 'Anna EVO-julkaisujen RSS-syötteen URL-osoite.';
$_lang["rss_url_releases_title"] = 'EVO-julkaisujen RSS-syöte';
$_lang["rss_url_extras_default"] = 'https://evo.im/rss/extras.xml';
$_lang["rss_url_extras_message"] = 'Anna EVO-lisäosien RSS-syötteen URL-osoite.';
$_lang["rss_url_extras_title"] = 'Extras-julkaisujen RSS-syöte';
...
$_lang["extras_release_tab"] = 'Evolution CMS Extras -julkaisut';
$_lang["extras_release_title"] = 'Evolution CMS Extras -julkaisut';
...
$_lang["site_timezone_title"] = 'Sivuston aikavyöhyke';
$_lang["site_timezone_message"] = 'Valitse IANA-aikavyöhyke. Sitä käytetään PHP:ssä ja sovelluksessa, ja se huomioi kesäajan automaattisesti.';
$_lang["serveroffset_deprecated_message"] = '<b>Vanhentunut:</b> tämä kiinteä siirtymä säilytetään yhteensopivuuden vuoksi eikä se huomioi kesäaikaa. Käytä ensisijaisesti sivuston aikavyöhykettä.';
...
$_lang["tmplvars_binding_msg"] = 'Kirjoita @ valitaksesi tietosidonnan';
...
$_lang['eventlog_system_user'] = 'Järjestelmä';
...
$_lang['mail_test_subject'] = 'Testiviesti vastaanottajalle :destination sivustolta :site';
$_lang['mail_test_automated_note'] = 'Tämä on automaattinen testiviesti. Vastausta ei tarvita.';
