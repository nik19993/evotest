...
$_lang["database_overhead"] = '<b style="color:#990033;">注意：</b>开销是 MySQL 保留但未使用的空间。要释放该空间，请点击相应表的开销值。';
$_lang["database_table_overhead"] = '开销';
...
$_lang["files_download_zip"] = '下载 ZIP';
$_lang["files_delete_zip"] = '删除 ZIP';
...
$_lang["image_base_upload_dir_message"] = '在文件浏览器中为此Web用户设置文件上传的根目录。您可以使用绝对路径、[(base_path)]占位符或相对于全局上传目录的路径。留空以使用系统默认值。';
$_lang["image_base_upload_dir_title"] = '文件浏览器上传根目录';
...
$_lang["modules"] = '模块';
$_lang["evo_release_title"] = 'Evolution CMS 版本发布';
...
$_lang["page_data_scheduled_publishdate"] = '计划发布日期';
$_lang["page_data_scheduled_publishdate_help"] = '如果设置计划发布日期，资源将在到达该日期时发布。留空则不进行自动计划发布。';
$_lang["page_data_actual_publishdate"] = '实际发布日期';
$_lang["page_data_actual_publishdate_help"] = 'publishedon 中保存的只读时间戳。它显示资源实际发布的时间。';
...
$_lang["rss_url_releases_message"] = '输入 EVO 版本 RSS 订阅源的 URL。';
$_lang["rss_url_releases_title"] = 'EVO 版本 RSS 订阅源';
$_lang["rss_url_extras_default"] = 'https://evo.im/rss/extras.xml';
$_lang["rss_url_extras_message"] = '输入 EVO 扩展 RSS 订阅源的 URL。';
$_lang["rss_url_extras_title"] = 'Extras 版本 RSS 订阅源';
...
$_lang["security"] = '保密机密';
$_lang["extras_release_tab"] = 'Evolution CMS Extras 版本发布';
$_lang["extras_release_title"] = 'Evolution CMS Extras 版本发布';
...
$_lang["site_timezone_title"] = '站点时区';
$_lang["site_timezone_message"] = '请选择 IANA 时区。该时区会应用于 PHP 和应用程序，并自动处理夏令时。';
$_lang["serveroffset_deprecated_message"] = '<b>已弃用：</b>此固定偏移仅为兼容性保留，不能处理夏令时。请优先使用站点时区。';
...
$_lang["tmplvars"] = '模板变量';
$_lang["tmplvars_binding_msg"] = '输入 @ 以选择数据绑定';
...
$_lang['mail_test_subject'] = '来自 :site 的测试消息，发送至 :destination';
$_lang['mail_test_automated_note'] = '这是一封自动测试邮件，无需回复。';
