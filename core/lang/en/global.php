...
$_lang["jit"] = 'JIT';
$_lang["opcache_memory_details"] = '(%s used / %s available), %s hits / %s misses';
$_lang["opcache_reset_unavailable"] = 'reset unavailable';
$_lang["opcache_reset_complete"] = 'reset complete';
$_lang["opcache_reset_failed"] = 'reset failed';
$_lang["database_name"] = 'Database name';
$_lang["database_overhead"] = '<b style="color:#990033;">Note:</b> overhead is unused space reserved by MySQL. To free it, click the overhead value for the corresponding table.';
...
$_lang["files_download_zip"] = 'Download ZIP';
$_lang["files_delete_zip"] = 'Delete ZIP';
...
$_lang["file_groups_saved"] = 'Access permissions saved.';
$_lang["file_groups_edit"] = 'Edit access permissions';
$_lang["files_groups"] = 'Resource Groups:';
$_lang["access_permissions_file_message"] = 'Select which Resource Groups this file belongs to:';
$_lang["access_permissions_dir_message"] = 'Select which Resource Groups this directory belongs to:';
$_lang["all_file_groups"] = 'All Resource Groups (Public)';
...
$_lang["image_base_upload_dir_message"] = 'Set the root upload directory for this web user in the file browser. You can use an absolute path, the [(base_path)] placeholder, or a path relative to the global upload directory. Leave empty to use the system default.';
$_lang["image_base_upload_dir_title"] = 'File Browser upload root';
...
$_lang["evo_release_title"] = 'Evolution CMS Releases';
$_lang["modx_security_notices"] = 'Evolution CMS Security Notices';
$_lang["evo_version"] = 'Evolution CMS version';
$_lang["monday"] = 'Monday';
$_lang["move"] = 'Move';
...
$_lang["page_data_scheduled_publishdate"] = 'Scheduled publish date';
$_lang["page_data_scheduled_publishdate_help"] = 'If you set a scheduled publish date, the Resource will be published when that date is reached. Leave it empty to avoid automatic scheduled publishing.';
$_lang["page_data_actual_publishdate"] = 'Actual publish date';
$_lang["page_data_actual_publishdate_help"] = 'Read-only timestamp stored in publishedon. It records when the Resource was actually published.';
...
$_lang["role_widget_online_info"] = 'View widget Online users';
...
$_lang["role_widget_recent_info"] = 'View widget Recently edited/created Resources';
...
$_lang["rss_url_releases_message"] = 'Enter the URL for the EVO releases RSS feed.';
$_lang["rss_url_releases_title"] = 'EVO Releases RSS Feed';
$_lang["rss_url_extras_default"] = 'https://evo.im/rss/extras.xml';
$_lang["rss_url_extras_message"] = 'Enter the URL for the EVO extras RSS feed.';
$_lang["rss_url_extras_title"] = 'Extras Releases RSS Feed';
...
$_lang["extras_release_tab"] = 'Evolution CMS Extras Releases';
$_lang["extras_release_title"] = 'Evolution CMS Extras Releases';
...
$_lang["site_timezone_title"] = 'Site timezone';
$_lang["site_timezone_message"] = 'Select an IANA timezone. It is applied to PHP and the application and automatically observes daylight saving time.';
$_lang["serveroffset_deprecated_message"] = '<b>Deprecated:</b> this static offset is kept for compatibility and does not account for daylight saving time. Prefer the site timezone setting.';
...
$_lang["tmplvars_binding_msg"] = 'Type @ to select data binding';
...
$_lang["html_comment_title"] = 'HTML comment';
$_lang["html_comment_message"] = 'Comma-separated list of element types to wrap with HTML comments in page source: <b>snippets</b>, <b>chunks</b>, <b>tvs</b>, <b>snippetParams</b>';
...
$_lang['mail_test_subject'] = 'Test message to :destination from :site';
$_lang['mail_test_body'] = "This is a test mail message from :site.\nMail method: :method\nSent at: :time";
$_lang['mail_test_automated_note'] = 'This is an automated test message. No reply is required.';
