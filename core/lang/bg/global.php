...
$_lang["files_download_zip"] = 'Изтегляне на ZIP';
$_lang["files_delete_zip"] = 'Изтриване на ZIP';
...
$_lang["image_base_upload_dir_message"] = 'Задайте коренната директория за качване на файлове за този уеб потребител в браузера на файловете. Можете да използвате абсолютен път, заместителя [(base_path)] или път относително към глобалната директория за качване. Оставете празно, за да използвате системната подразбиране.';
$_lang["image_base_upload_dir_title"] = 'Коренна директория за качване на браузер';
...
$_lang["evo_release_title"] = 'Релизи на Evolution CMS';
...
$_lang["page_data_scheduled_publishdate"] = 'Планирана дата на публикуване';
$_lang["page_data_scheduled_publishdate_help"] = 'Ако зададете планирана дата на публикуване, ресурсът ще бъде публикуван при настъпване на тази дата. Оставете празно, за да не планирате автоматично публикуване.';
$_lang["page_data_actual_publishdate"] = 'Действителна дата на публикуване';
$_lang["page_data_actual_publishdate_help"] = 'Времеви печат само за четене, записан в publishedon. Показва кога ресурсът действително е публикуван.';
...
$_lang["rss_url_releases_message"] = 'Въведете URL адреса на RSS емисията за релизите на EVO.';
$_lang["rss_url_releases_title"] = 'RSS емисия на релизите на EVO';
$_lang["rss_url_extras_default"] = 'https://evo.im/rss/extras.xml';
$_lang["rss_url_extras_message"] = 'Въведете URL адреса на RSS емисията за добавките на EVO.';
$_lang["rss_url_extras_title"] = 'RSS емисия на релизите на Extras';
...
$_lang["extras_release_tab"] = 'Релизи на Evolution CMS Extras';
$_lang["extras_release_title"] = 'Релизи на Evolution CMS Extras';
...
$_lang["site_timezone_title"] = 'Часова зона на сайта';
$_lang["site_timezone_message"] = 'Изберете часова зона IANA. Тя се прилага към PHP и приложението и автоматично отчита лятното часово време.';
$_lang["serveroffset_deprecated_message"] = '<b>Остаряло:</b> това статично отместване е запазено за съвместимост и не отчита лятното часово време. Предпочитайте часовата зона на сайта.';
...
$_lang["tmplvars_binding_msg"] = 'Въведете @, за да изберете свързване на данни';
...
$_lang['mail_test_subject'] = 'Тестово съобщение до :destination от :site';
$_lang['mail_test_automated_note'] = 'Това е автоматично тестово съобщение. Не е необходим отговор.';
