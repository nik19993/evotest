...
<div class="tab-page" id="tabPage4">
    <h2 class="tab"><?php echo e(__('global.settings_email_templates')); ?></h2>
    ...
    <div class="container container-body">
        ...
        <div class="smtpRow" <?php if($settings['email_method'] == 'mail'): ?> style="display: none;" <?php endif; ?>>
            <?php echo $__env->make('manager::form.radio', [
                'name' => 'smtp_auth',
        ...
        <div class="row form-row form-element-input" id="mailTestPanel" data-endpoint="index.php" data-action="<?php echo e(\EvolutionCMS\Controllers\MailTest::ACTION_ID); ?>" data-token="<?php echo e(csrf_token()); ?>">
            <label class="control-label col-5 col-md-3 col-lg-2" for="mailTestDestination">
                <?php echo e(__('global.mail_test_title')); ?>
            ...
            <div class="col-7 col-md-9 col-lg-10">
                <div class="input-group">
                    <input
                        ...
                        autocomplete="email"
                        required
                        placeholder="<?php echo e(__('global.mail_test_destination')); ?>"
                    >
                    <div class="input-group-append">
                        <button class="btn btn-secondary" type="button" id="mailTestSend" form="mailTestForm">
                            <?php echo e(__('global.mail_test_send')); ?>

                        </button>
                    </div>
                </div>
                <small class="form-text text-muted"><?php echo e(__('global.mail_test_help')); ?></small>
        ...
        <?php echo get_by_key($tabEvents, 'OnUserSettingsRender'); ?>
            ...
            sendButton.addEventListener('click', function() {
                ...
                fetch(panel.dataset.endpoint, {
                        ...
                        return response.json()
                            ...
                            .then(function(payload) {
                                if (!response.ok || payload.success !== true) {
                                    throw new Error(payload.message || '<?php echo e(__('global.mail_test_error')); ?>');
                                }
                    ...
                    .catch(function(error) {
                        showFeedback(error.message || '<?php echo e(__('global.mail_test_error')); ?>', false);
                    })
                    .finally(function() {
...
<?php $__env->stopPush(); ?>
<?php /**PATH /var/www/html/manager//views//page/system_settings/mail_templates.blade.php ENDPATH**/ ?>