...
<div class="tab-page" id="tabPage8">
    <h2 class="tab"><?php echo e(__('global.settings_KC')); ?></h2>
    ...
    <div class="container container-body">
        ...
        <div class="rbRow" <?php if(!$settings['use_browser']): ?> style="display: none;" <?php endif; ?>>
        ...
        <?php echo get_by_key($tabEvents, 'OnMiscSettingsRender'); ?>

    </div>
</div>
<?php /**PATH /var/www/html/manager//views//page/system_settings/file_browser.blade.php ENDPATH**/ ?>