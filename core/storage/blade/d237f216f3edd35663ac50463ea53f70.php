...
<div class="tab-page" id="tabPage5">
    <h2 class="tab"><?php echo e(__('global.settings_ui')); ?></h2>
    ...
    <div class="container container-body">
        ...
        <div <?php if(empty($evtOut)): ?> style="display: none;" <?php endif; ?>>
            ...
            <div class="editorRow" <?php if(empty($settings['use_editor'])): ?> style="display: none;" <?php endif; ?>>
        ...
        <?php echo get_by_key($tabEvents, 'OnInterfaceSettingsRender'); ?>

    </div>
</div>
<?php /**PATH /var/www/html/manager//views//page/system_settings/interface.blade.php ENDPATH**/ ?>