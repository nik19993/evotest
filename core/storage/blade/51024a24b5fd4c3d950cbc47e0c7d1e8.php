...
<div class="tab-page" id="tabPageSecurity">
    <h2 class="tab"><?php echo e(__('global.settings_security')); ?></h2>
    ...
    <div class="container container-body">
        ...
        <div class="udPerms" <?php if(!$settings['use_udperms']): ?> style="display: none;" <?php endif; ?>>
            <?php echo $__env->make('manager::form.radio', [
        ...
        <div class="captchaRow" <?php if(!$settings['use_captcha']): ?> style="display: none;" <?php endif; ?>>
            <?php echo $__env->make('manager::form.textarea', [
                'name' => 'captcha_words',
        ...
        <?php echo get_by_key($tabEvents, 'OnSecuritySettingsRender'); ?>

    </div>
</div>
<?php /**PATH /var/www/html/manager//views//page/system_settings/security.blade.php ENDPATH**/ ?>