<?php if(EvolutionCMS()->getConfig('enable_debug')): ?>
    ...
    <div class='debug' id='debug' name='debug' onClick="removeDebugDiv();">
        <table border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
                ...
                <td width="80"><?php echo e(printf ('%6.5f s', microtime(true) - EvolutionCMS()->tstart)); ?></td>
            </tr>
        </table>
    </div>
<?php endif; ?>
<?php /**PATH /var/www/html/manager//views//partials/debug.blade.php ENDPATH**/ ?>